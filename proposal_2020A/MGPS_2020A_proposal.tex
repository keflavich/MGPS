...
to survey the plane, and we demonstrated combination with zero-spacing\footnote{MUSTANG-2, like similar bolometer arrays, is sensitive only to scales $\lesssim4.5\arcmin$ because of the common-mode atmosphere removal process.} provided
...
semesters.  In this proposal, we request 90h to observe the region from
Galactic longitude -5 to 55 degrees in the upcoming A semester.

A pilot program has been completed and a paper is in preparation.  The paper
can be viewed at \url{https://www.overleaf.com/read/syctsjqcxbrr} and we plan
to submit this calendar year.
