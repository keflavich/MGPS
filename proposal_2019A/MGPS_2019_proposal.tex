...
Based on our population synthesis modeling of evolved \hii regions and the above sensitivity limits, we estimate that there are $\sim$3500 total \hii regions in our survey zone. How many of these are \hchii regions heavily depends on their average lifetimes, but by assuming an average \hchii region lifetime of 10$^{5}$ years we expect to detect $\sim$60 undiscovered \hchii regions. Deviations from this number of detections will help us better estimate the accreting lifetime of proto-OB stars.
