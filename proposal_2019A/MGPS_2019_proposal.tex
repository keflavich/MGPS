...
\begin{enumerate}
    ...
    \item What is the spatial distribution of the dust $\beta$ index?  Do grains grow
...
\todo{We have demonstrated the ability to combine ALMA and MUSTANG data... }
...
\begin{figure}
\includegraphics[width=18cm]{W43_RGB_90cm_MGPS_JPS.png}
...
\todo{Sgr B2 is also included in this version}
}
\label{fig:figure}
\end{figure}
