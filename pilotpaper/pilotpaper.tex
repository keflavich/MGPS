    ...
    \item A map is made in IDL (in azimuth/elevation coordinates) of each
        ...
        \begin{enumerate}
            ...
            \item The beam volume is calculated from the map within a 60\arcsec
                ...
                adopted beam volume from the \edit{model} is preferred, but
                % Charles, please help here
                \edit{if the resultant beam volume from the model appears spurious, the 60\arcsec aperture value is
                adopted. There is not a formal criterion (e.g. threshold) for a spurious beam volume. If an individual scan yields a beam volume that appears to deviate substantially from the trend produced by neighboring calibration scans, it may be excluded.}
...
images, the morphology of these images is affected relatively little.}  We
