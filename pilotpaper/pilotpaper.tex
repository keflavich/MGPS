    ...
    \item
        \begin{enumerate}
            \item The peaks of secondary calibrators are normalized by the mean
                ...
                planetary models if a planet or from interpolation of ALMA data \citep{vanKempen2014,Fomalont2014}
...
\todo{A complete description of the catalog columns is shown in Appendix XXXX.}
