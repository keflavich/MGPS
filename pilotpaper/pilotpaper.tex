...
We have identified \nsources compact sources over seven observed fields selecting some of
the most prominent millimeter-bright regions between $0\arcdeg < \ell < 50\arcdeg$
(total area $\approx 7.5 $ square degrees).  The majority of these sources have
