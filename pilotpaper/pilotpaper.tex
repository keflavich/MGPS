...
beam.  We describe the survey parameters, quality assessment process, cataloging,
...
we successfully identified several known hypercompact HII (\hchii) regions,
but did not find any new ones.  We identify \mmdetectionscmnondetections sources
that have mm-wavelength counterparts but do not have cm-wavelength counterparts
and are therefore candidate \hchii regions; of these,
\mmdetectionscmnondetectionscompact are morphologically compact and are
stronger candidates. 
We separated the 3 mm emission into dust and free-free emission by comparing with
archival 870 \um and 20 cm data.  In the selected pilot fields, the emission is
dominated by (which emission mechanism?)
\end{abstract}
...
MUSTANG-2 \citep{Dicker2014a} is a 223 element bolometer array operating on the 100~m
    ...
    \item
        \begin{enumerate}
            \item The peaks of secondary calibrators are normalized by the mean
                ...
                if only an ALMA calibrator is accessible. The scaling is
...
of OB and Wolf-Rayet stars in the region powering the expanding HII region may also
drive strong shocks into the surrounding medium \citep[e.g.][]{Bally2010a}.
...
{\color{red}
Generally, all of the selected bright, extended regions are dominated by
contributions from either free-free or synchrotron emission at 3 mm.
In Table \ref{tab:freefreefrac}, we break down the contribution
of free-free and dust emission to the total within a selected sub-region.
Dust contributes no more than 20\% of the total emission to any of these.

Region     Free-free  Dust
sgrb2           0.869      0.135
sgra            0.843      0.178
arches          0.926      0.077
g34             0.798      0.212
