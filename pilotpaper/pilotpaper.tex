...
Maps were made using the MINKASI algorithm \citep{}.
...
\begin{table*}[htp]
    \begin{tabular}{llll}
TARGET   &    IDL   &   MINKASI & MINKASI 4" smooth\\
\hline
GAL029   &      3.7 &     2.6   & 1.1\\
GAL031   &      6.1 &     4.1   & 1.8\\
SgrB2    &     8.0  &    7.4    & 2.2\\
...
Because several corrections were required, we assume the absolute pointing accuracy is $\sim4\arsec$.
We therefore cross-correlated the MUSTANG-2 maps with [TODO: BGPS, ATLASGAL, Planck, HiGal are all fine candidates]
