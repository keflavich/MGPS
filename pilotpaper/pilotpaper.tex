...
thin free-free emission (which is incorrect; these maps contain both synchrotron
emission and optically thick free-free emission) following a power law $S_{\nu}
...
dominated regions, likely indicating that there is likely substantial nonthermal
emission in these HII regions \todo{Is there any other explanation?  That seems
like kind of a big deal.}(CITE: Padovani+ in prep on synchrotron emission from
HII regions).  However, despite this clear oversubtraction, the
difference image shows an exquisite high-resolution image of the compact
dust-dominated features.
...
The white bar in the lower-left is a 1\arcminute scalebar.
...
10\arcsec.  The asymmetry in the MUSTANG image is caused by the missing
