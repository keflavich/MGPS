...
appears to match well to other data sets you have.}
...
planetary nebula (Fig. \ref{fig:g29pn}), which exhibits emission at all wavelengths,
an OH/IR star (Fig. \ref{fig:g31ohir}) that is infrared- and millimeter-bright but
not detected at centimeter wavelengths, and a high-mass YSO that is a candidate
\hchii region with no centimeter detection (Fig. \ref{fig:g12hiicand}).
...
\begin{figure*}[htp]
\includegraphics[width=17cm]{figures/SED_plot_G29_G29.578-0.268.png}
...
\begin{figure*}[htp]
\includegraphics[width=17cm]{figures/SED_plot_G12_G12.026-0.031.png}
...
\begin{figure*}[htp]
\includegraphics[width=17cm]{figures/SED_plot_G31_G30.944+0.035.png}
