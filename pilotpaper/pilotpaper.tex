...
While we would expect some excess above the extrapolated dust emissivity for
...
% G12.908-0.260: star?
% G29.578-0.267: full SED.  Star?  Coordinate offset evident; check if this one is fixed w/re-cataloging
%  CLEAR pointing offset in G29 means cataloging needs to be redone
