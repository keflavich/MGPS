...
\begin{abstract}
%\todo{COAUTHORS: Please look at the file \texttt{authors.tex} and add your affiliation etc.}\\
    ...
    \item A map is made in IDL (in azimuth/elevation coordinates) of each
        ...
        \begin{enumerate}
            ...
            \item Fixing the centroid as found above, a double Gaussian is fit.
                ...
                response.
            \item
                \edit{The beam solid angle is calculated both from the fitted model parameters
                and from the sum within a 60\arcsec aperture.  These measurements
                were consistent, so the analytically derived solid angles from the fitted
...
The absolute accuracy of these calibrations should be about 10\%.  Some of this
...
pipeline which is based on the maximum likelihood pipeline written for the \change{Atacama Cosmology Telescope \citep[ACT;][]{Dunner2013a}}.
...
resulting in a 9\arcsec beam.  \edit{This smoothing substantially increases
the signal-to-noise in each pixel at a modest cost in beam area.}
...
milliseconds, \edit{corresponding to angular scales of XXX at our scan rate
of YYYY arcseconds/second}.
...
Herschel Hi-GAL       & 70--500        &  6--36               & 20-85  & \citet{Elia2017a} \\
...
\edit{ the source is saturated in these Hi-GAL bands}.  The asymmetry in the
