...
The example in Figure \ref{fig:sgrb2_freefree} shows good agreement between the
...
dominated regions, likely indicating that much of the free-free emission is
optically thick at 20 cm.  However, despite this clear oversubtraction, the
...
\begin{figure*}[htp]
    ...
    All images are displayed on the same intensity scale in units of Jy/sr.
    (a; 3 mm) MGPS90 
    (b; 3 mm Dust) ATLASGAL 870 \um scaled to 3 mm
    (c; 3 mm free-free) smoothed MGPS90 - scaled ATLASGAL
    (d; 20 cm) VLA 20 cm continuum scaled to 3 mm
    (e; 3 mm Dust) smoothed MGPS90 - scaled VLA 20 cm continuum.
}
...
\begin{figure*}[htp]
    ...
    See Figure \ref{fig:sgrb2_freefree}.
}
