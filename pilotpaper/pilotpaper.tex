...
some is from our knowledge of $\tau$ (the sky optical depth) during the observations.  \todo{Simon, or MUSTANG team: Does this use Ron Maddalena's weather model, or does it come from sky dips, or something else?}
...
applied. \todo{MUSTANG team: could you clarify this section?  What is the `variance beam'?}
...
\begin{figure*}[htp]
    ...
    the arc shape in the center is purely free-free emission \citep{Ginsburg2016a}, but
    it is optically thick at long wavelengths.
    \todo{I'm concerned that there's still a spatial offset here.}
}
