...
\begin{enumerate}
    \item $S_{3 \mathrm{mm}} > 1.75 S_{6 \mathrm{cm}}$.% or $S_{3 \mathrm{mm}} > S_{20 \mathrm{cm}}$.
        This requirement selects free-free sources that are optically
        thick at $\lambda>{6 \mathrm{cm}}$.
    \item
        The source is not detected at 6 and 20 cm, is detected at 1.1 mm, and has
        $S_{3 \mathrm{mm}} / S_{1.1 \mathrm{mm}} < \left(S_{3 \mathrm{mm}} /
        S_{1.1 \mathrm{mm}})^{-3}\right)$,  where $\alpha=3$ is the spectral
...
\citep[$\approx2.5$ mJy at 6 cm][]{Given2005a,Hoare2012a}.  While we would
