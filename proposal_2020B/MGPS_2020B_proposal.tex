...
\newcommand{\MGPS}{\textsc{MGPS90}\xspace}
\begin{document}
...
A Galactic Plane Survey (GPS) at 3 mm and 9\arcsec resolution with the GBT will provide a
...
proposal is to complete the first segment of the \MUSTANG-GPS (MGPS).  With
our previous pilot program, we demonstrated the power and efficiency of \MUSTANG
to survey the plane, and we demonstrated combination with
zero-spacing\footnote{MUSTANG-2 is sensitive
only to scales $\lesssim4.5\arcmin$ because of the common-mode atmosphere
removal process.} provided
from the Planck mission and high-resolution (sub-arcsecond) observations from ALMA.

Because of the relatively limited observing windows for 3 mm observations in
Galactic time, we are planning to spread the observations over several
semesters.  In this proposal, we request 96h to observe the region from
Galactic longitude -5 to 35 degrees in the upcoming A semester.

A pilot program has been completed and a paper is submitted\footnote{You can
view the paper draft at \url{https://www.overleaf.com/read/syctsjqcxbrr}}. 
%\footnote{\url{dataverse.harvard.edu/dataverse/MGPS}}
...
censuses and therefore the tools to study carefully selected populations of
forming stars.
We propose a survey of the inner 40 degrees of the northern
...
\textit{Results from the pilot survey:} The pilot program covered 6 square degrees
and recovered the known, isolated \hchii regions in those fields.  It detected
8 candidate \hchii regions with 3 mm detections but no cm detection and compact
3 mm emission.
Comparison to the CORNISH \uchii sample \citep{Kalcheva2018a} suggests that the \hchii/\uchii
lifetime ratio is in the range 1/6 to 1/2, hinting at an intermediate \hchii lifetime
in the several $10^4$ year range.  However, the pilot sample is highly biased toward
crowded, intensely star-forming regions, so it does not necessarily represent
...
accurate mass measurements have been enabled by \textit{Herschel} observations.
For more massive clouds in the Galactic plane, free-free contamination and
spatial confusion significantly hamper mass measurements and can easily lead to
wrong conclusions about the density structure of clouds.  The increased
free-free contribution at higher mass implies that there is a bias toward
observing shallower cloud mass distributions.  By providing better constraints
on the free-free contribution to the cloud SEDs,  particularly on the high-mass
tail where contamination is most significant, the \MGPS will enable more
accurate dust mass calculations and correct this bias.
...
\textbf{Other properties of extended 3 mm emission.}  Maps at 3 mm can be used
to explore emission excesses in diffuse gas, such as anomalous microwave
emission \citep[e.g.,][]{Mason2019a} or synchrotron emission in HII regions
\citep[e.g.,][]{Padovani2019a}.  In the pilot fields, we noted several
regions where the VLA-observed diffuse 20 cm emission extrapolated to 3 mm
assuming optically thin free-free emission predicts fluxes greater than those
observed, hinting that there is nonthermal (probably synchrotron) emission
tightly correlated with the observed free-free emission.
...
\citep[1.1 mm][]{Ginsburg2013a}.  More recently, there are incomplete
...
AzTEC on the LMT \citep[e.g.][]{Lin2016a}. These surveys provide the data needed to completely
...
dataverse\footnote{The dataverse at
\url{https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi\%3A10.7910\%2FDVN\%2FHPATJB}
will be published with the pilot paper}.  The team has assigned
...
Image data products will be released within 1 year from data acquisition,
and catalog products (which require additional vetting) 6 months after
the image release.
...
\begin{figure}
\includegraphics[width=9cm]{W43_RGB_90cm_MGPS_JPS_inset_arrows_SEDfit.png}
\includegraphics[width=9cm]{SgrB2_RGB_20cm_MGPSplanck_ATLASGAL.png}
%\includegraphics[width=5.5cm]{MUSTANGwithSCUBA450contoursB.png}
\caption{
(left) A color composite of VLA 90 cm (red), \MGPS (green), and JPS 850 \um (blue)
...
GHz.
(right) VLA 20 cm (red), \MGPS combined with Planck (green), and ATLASGAL
...
%{\color{red} Bibliographies take space and leaving them out didn't seem to cause complaints until 2019B...}
%\begin{multicols}{3}
%\begin{spacing}{0.5}
\clearpage
