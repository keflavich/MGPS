...
files = {'G29':'G29/GAL_029_precon_2_arcsec_galactic_white_alt_svd_pass_8.fits',
         ...
         'G49':'W51/W51_precon_2_arcsec_pass_10.fits',
        }
dirs = {'G29':'G29',
        'G31':'GAL_031',
        'G01':'SgrB2',
...
for regname, fn in files.items():
    ...
    planck_image.writeto('planck/{0}_100GHz.fits'.format(regname))
    ...
    rslt = uvcombine.feather_simple(fh, planck_image)

    fh[0].data = rslt.real
    fh.writeto("{0}/{1}_PlanckCombined.fits".format(dirs[regname], fh.replace(".fits","")))
