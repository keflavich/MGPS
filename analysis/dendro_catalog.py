...
def dendrocatify(regname, fn, threshold=4, min_npix=100, min_delta=1,
    ...
    rejected = radiosource.catalog['MUSTANG_dend_flux'] / filt_avg_noise < snr_threshold
...
if __name__ == "__main__":
    ...
    #if True:
    #    regname='G49'; fn = files[regname]
    for regname,fn in files.items():
        print(regname, fn)
        radiosource, dend, mastercatalog, ppcat = dendrocatify(regname, fn)
